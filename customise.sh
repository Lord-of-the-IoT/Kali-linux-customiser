...
apt-get install git silenttrinity cyberchef gobuster armitage seclists graphicsmagick-imagemagick-compat  maltego remmina putty-tools chisel sshuttle backdoor-factory veil powershell-empire starkiller gdb
